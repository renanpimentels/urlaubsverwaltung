      ...
      <div className="mb-4 flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
        ...
        {unreadCount > 0 ? (
          <button
            ...
            disabled={isPending}
            className="w-fit rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
          >
